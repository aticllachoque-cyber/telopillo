...
// Keyword-only (profiles have no embeddings) and phone-free by design: the
// search_profiles RPC projects profiles_public fields only (TELO-003) and is
// restricted to profiles with at least one active listing.
