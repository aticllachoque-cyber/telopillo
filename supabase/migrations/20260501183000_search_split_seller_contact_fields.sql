-- =============================================================================
-- Search: expose business WhatsApp and profile phone separately (plus legacy
-- seller_whatsapp_phone COALESCE) so the client can fall back when business
-- value does not normalize.
-- =============================================================================
...
BEGIN
  ...
  WITH filtered AS (
    SELECT
      ...
      pr.phone AS seller_profile_phone,
      COALESCE(bp.social_whatsapp, pr.phone) AS seller_whatsapp_phone,
      CASE
