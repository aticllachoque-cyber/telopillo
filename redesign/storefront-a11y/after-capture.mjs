// Stage 8 after-captures for storefront-a11y — 3 viewports x 2 states, fullPage dsf=2.
// Same discipline as capture.mjs (Stage 3), pointed at after/ on the branch code.
...
await browser.close()
console.log('after-captured:', manifest.length, 'shots')
